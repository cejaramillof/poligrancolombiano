class FoodTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @food_type.save
        format.html { redirect_to @food_type.food_group, notice: 'Food type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @food_type.update(food_type_params)
        format.html { redirect_to @food_type.food_group, notice: 'Food type was successfully updated.' }
  ...
  def destroy
    @food_type.destroy
    respond_to do |format|
      format.html { redirect_to @food_type.food_group, notice: 'Food type was successfully destroyed.' }
  ...
  private
    ...
    def food_type_params
      params.require(:food_type).permit(:name, :kcal, :proteins, :carbs, :fats, :food_group_id)
    end
end
